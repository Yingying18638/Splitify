...
const buttonVariants = cva(
  "inline-flex items-center justify-center xl:text-[16px] whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          "bg-[#F9EECE] xl:h-11 xl:rounded-md xl:px-8 shadow-md text-[#653A14] hover:bg-[#F9EECE]/60 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-800/80",
        ghost:
